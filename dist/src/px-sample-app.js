"use strict";(function(){Polymer({is:"px-sample-app",properties:{/**
       ...
       * @property items
       */items:{type:Array,value:function value(){return[{label:"North America",id:"North_America",children:[{label:"United States",id:"United_States",children:[{label:"California",id:"California",children:[{label:"San Diego",id:"San Diego"},{label:"San Francisco",id:"San Francisco"},{label:"San Mateo",id:"San_Mateo"}]}]}]}]}},/**
       * Used by the px-context-browser to select an asset in the hierarchy.
       * @property selectedRoute
       */selectedRoute:{type:Array,value:function value(){return["North_America","United_States","California","San Diego"]},observer:"getSelection"},/**
